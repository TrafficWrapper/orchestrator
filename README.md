...
| `ORCH_REALITY_FALLBACK_PROFILES` | Add workers' XHTTP REALITY profiles as fallback routes after the primary route. | Optional | `0` | See ARCHITECTURE "REALITY Vision, Short ID Cohorts and AWG Rotation". |
