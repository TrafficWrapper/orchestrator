...
| `ORCH_REALITY_FALLBACK_PROFILES` | Добавлять XHTTP REALITY-профили воркеров fallback-маршрутами после основного. | Опц. | `0` | См. ARCHITECTURE «REALITY Vision, когорты short ID и ротация AWG». |
